...
$dictionary["OutboundEmailAccounts"] = array(
    ...
    array(
        ...
        'mail_xoauth2user' => array(
            'name' => 'mail_xoauth2user',
            'vname' => 'LBL_MAIL_XOAUTH2USER',
            'type' => 'varchar',
            'len' => 100,
            'reportable' => false,
        ),
        'mail_xoauth2type' => array(
            'name' => 'mail_xoauth2type',
            'vname' => 'LBL_MAIL_XOAUTH2TYPE',
            'type' => 'varchar',
            'len' => 20,
            'required' => true,
            'default' => 'other',
        ...
        'mail_xoauth2clientid' => array(
            'name' => 'mail_xoauth2clientid',
            'vname' => 'LBL_MAIL_XOAUTH2CLIENTID',
            'type' => 'varchar',
            'len' => 255,
            'required' => true,
            'default' => '',
        ...
        'mail_xoauth2clientsecret' => array(
            'name' => 'mail_xoauth2clientsecret',
            'vname' => 'LBL_MAIL_XOAUTH2CLIENTSECRET',
            'type' => 'varchar',
            'len' => 255,
            'required' => true,
            'default' => '',
        ...
        'mail_xoauth2_token' => array(
            'name' => 'mail_xoauth2_token',
            'vname' => 'LBL_MAIL_XOAUTH2_TOKEN',
            'type' => 'varchar',
            'len' => 255,
            'required' => true,
            'default' => '',
